...
void menu_advanced_settings();
  ...
  void menu_config_retract() {
    ...
    #endif
    EDIT_ITEM(float52sign, MSG_CONTROL_RETRACT, &fwretract.settings.retract_length, 0, 10);
    #if HAS_MULTI_EXTRUDER
    ...
    EDIT_ITEM(float52sign, MSG_CONTROL_RETRACT_ZHOP, &fwretract.settings.retract_zraise, 0, 1);
    EDIT_ITEM(float52sign, MSG_CONTROL_RETRACT_RECOVER, &fwretract.settings.retract_recover_extra, -1, 1);
    #if HAS_MULTI_EXTRUDER
